 ...
 * @version    $Id: layouts.php 23775 2011-03-01 17:25:24Z ralph $
 */

/**
 * Provide layouts support for MVC applications
 *
 * @category   Zend
 * @package    Zend_Layout
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
...
class Zend_Layout
{
     ...
     *
     * layouts script path, either as argument or as key in options, is
     * required.
     *
    ...
    public function __construct($options = null, $initMvc = false)
    {
        if (null !== $options) {
            if (is_string($options)) {
                ...
                require_once 'Zend/layouts/Exception.php';
