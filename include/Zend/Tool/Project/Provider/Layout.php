 ...
 * @version    $Id: layouts.php 24408 2011-08-26 22:05:35Z adamlundrigan $
 */
...
class Zend_Tool_Project_Provider_Layout extends Zend_Tool_Project_Provider_Abstract implements Zend_Tool_Framework_Provider_Pretendable
{
    ...
    public function disable()
    {
        ...
        if ($this->_registry->getRequest()->isPretend()) {
            ...
            $this->_registry->getResponse()->appendContent('layouts entry has been removed from the application config file.');
